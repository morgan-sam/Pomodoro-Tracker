...
const Dropdown = (props) => {
    ...
    ? props.options.map(function (el, i) {
        ...
        return (
          <div
            ...
            className={`${
              props.className
            } dropdown-box dropdown-option ${getCurrentOptionClass(
              el,
              props.options
            )}`}
            onMouseDown={() => {
  ...
  return (
    <div
      className={`${props.className} dropdown-parent`}
      style={{ ...props.style }}
    >
      <div
        className={`${props.className} dropdown-element ${
          darkTheme ? "dark-theme" : ""
        }`}
      >
        <div
          className={`${props.className} dropdown-option-container ${
            listOpen ? "dropdown-open" : "dropdown-closed"
          }`}
          ref={dropdownRef}
        >
